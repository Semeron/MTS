...
fore_num=24
f_dim=862
ymean,ystd,train_dl,val_dl,xtest,ytest=troch_data(seq_len,fore_num,data,bsz=50,val_tatio=0.2,test_ratio=0.2)

model=TransAm(seq_len=seq_len,feature_size=f_dim,out_size=fore_num,d_model=2048, num_layers=1, dropout=0.5)
...
model_path= '../best_model/trans_model.pth'
