...
from model.LSTM_atten_model import LSTM_Atten
...
model=LSTM_Atten(seq_len,fore_num, f_dim=f_dim,h_dim=50,layer=2)
...
model_path= '../best_model/lstm_atten_model.pth'
